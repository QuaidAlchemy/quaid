...
import pytest
from quaid.data.cli.cli import data as cli
from quaid.data.schema.legacy import CrystalCompoundData
from quaid.data.services.fragalysis.fragalysis_download import (
