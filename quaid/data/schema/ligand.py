...
from quaid.data.backend.rdkit import rdkit_mol_to_sdf_str
...
from quaid.data.schema.schema_base import DataStorageType
...
class Ligand(DataModelAbstractBase):
    ...
    def to_rdkit(self) -> "Chem.Mol":
        ...
        """
        from quaid.data.backend.rdkit import sdf_str_to_rdkit_mol, set_SD_data
        from rdkit import Chem
